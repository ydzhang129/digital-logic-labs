module clock(
    input wire clk,
    input wire [4:0] button,//up 0 center 1 down 2 left 3 right 4 
    input wire [1:0] sign,
    ...
    always@(posedge clk)begin //防抖
        if(button_pro!=button)begin
            delay<=delay+1;
        end else begin delay<=0; end
        if(delay==99999)begin 
            button_pro<=button;
        end else begin end
    end
    
    always@(posedge clk) button_d <= button_pro;
    ...
    always@(*)begin //hour bcd
        ...
        if(show_real_time)begin
            for(i=0;i<5;i=i+1)begin
                if(hour_bcd[7:4]>=5) hour_bcd[7:4]=hour_bcd[7:4]+3;
                if(hour_bcd[3:0]>=5) hour_bcd[3:0]=hour_bcd[3:0]+3;
                hour_bcd=hour_bcd<<1;
    ...
    always@(*)begin //min bcd
        ...
        if(show_real_time)begin
            for(i=0;i<6;i=i+1)begin
                if(min_bcd[7:4]>=5) min_bcd[7:4]=min_bcd[7:4]+3;
                if(min_bcd[3:0]>=5) min_bcd[3:0]=min_bcd[3:0]+3;
                min_bcd=min_bcd<<1;
    ...
    always@(*)begin //sec bcd
        ...
        if(show_real_time)begin
            for(i=0;i<6;i=i+1)begin
                if(sec_bcd[7:4]>=5) sec_bcd[7:4]=sec_bcd[7:4]+3;
                if(sec_bcd[3:0]>=5) sec_bcd[3:0]=sec_bcd[3:0]+3;
                sec_bcd=sec_bcd<<1;
    ...
    always@(*)begin
        case(digital)//最右侧为digital 0
            3'b000:begin  an=8'b11111110;curr_num=sec_bcd[ 3: 0];end
            3'b001:begin  an=8'b11111101;curr_num=sec_bcd[ 7: 4];end
            3'b010:begin  an=8'b11111011;curr_num=4'b1111;end //代表小短横线
            3'b011:begin  an=8'b11110111;curr_num=min_bcd[3:0];end
            3'b100:begin  an=8'b11101111;curr_num=min_bcd[7:4];end
            3'b101:begin  an=8'b11011111;curr_num=4'b1111;end
            3'b110:begin  an=8'b10111111;curr_num=hour_bcd[3:0];end
            3'b111:begin  an=8'b01111111;curr_num=hour_bcd[7:4];end
            default:begin an=8'b11111111;curr_num=4'b1111;end
        endcase
        case(curr_num)
            4'b0000: num=7'b1000000;//0
            4'b0001: num=7'b1111001;//1
            4'b0010: num=7'b0100100;//2
            4'b0011: num=7'b0110000;//3
            4'b0100: num=7'b0011001;//4
            4'b0101: num=7'b0010010;//5
            4'b0110: num=7'b0000010;//6
            4'b0111: num=7'b1111000;//7
            4'b1000: num=7'b0000000;//8
            4'b1001: num=7'b0010000;//9
            4'b1111: num=7'b0111111;//-
